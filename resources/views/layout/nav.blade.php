...
<nav class="site-navbar  navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-blue-600" role="navigation">
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="{{ asset('assets/img/logo.png')}}" title="SOP">
        <span class="navbar-brand-text hidden-xs-down">SOP©  - V.1.0</span>
      </div>
                    ...
                    <ul class="blocks-3">
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="{{ asset('assets/img/logo1.png')}}" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="{{ asset('assets/img/logo.png')}}" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
